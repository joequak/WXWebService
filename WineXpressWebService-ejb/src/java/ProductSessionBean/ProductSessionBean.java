...
public class ProductSessionBean implements ProductSessionBeanLocal {
    ...
    @Override
    public long saveNewProduct(String productName, double productPrice, double productCost, String productDescription, int productAQ, int productDiscount, String productVolume, String productCountry) {
    ...
    public void editProduct(Product newProduct) {
        ...
        origin.setCountry(newProduct.getCountry());
        em.persist(origin);
